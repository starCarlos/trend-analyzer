(function () {
  ...
  const MESSAGES = {
    zh: {
      ...
      tracked: {
        ...
        dashboard_kicker: "回看页",
        dashboard_chip: "本地追踪",
        dashboard_title: "追踪",
        dashboard_note: "点标题回到趋势页；排障时再展开下面工具。",
        dashboard_active: "共 {count} 个追踪对象，其中 {repos} 个仓库、{keywords} 个关键词。最近更新 {latest}。",
        dashboard_empty: "还没有追踪对象。先去搜索页留下想反复回看的仓库或关键词。",
        stat_total: "正在追踪",
        stat_total_detail: "观察列表中的对象总数",
        stat_latest: "最近更新",
        stat_latest_detail: "追踪列表里最新一次写入时间",
        stat_scheduler: "调度器",
      ...
      ops: {
        title: "排障工具",
        subtitle: "平时不用看；只有查采集或真实源时才展开。",
        open: "展开排障工具",
        close: "收起排障工具",
        focus_note: "先选一个问题：看调度器、查真实源，或者临时补抓。",
    ...
    en: {
      ...
      tracked: {
        ...
        dashboard_kicker: "Revisit",
        dashboard_chip: "Local watchlist",
        dashboard_title: "Tracked",
        dashboard_note: "Open the title to jump back into the trend page. Open troubleshooting only when needed.",
        ...
        stat_latest_detail: "Newest write time visible in the watchlist",
      ...
      ops: {
        ...
        subtitle: "Ignore this in normal use. Open only when checking collection or realtime providers.",
        open: "Open troubleshooting",
        close: "Hide troubleshooting",
  ...
  function renderTrackedOverview() {
    ...
    const stats = [
      ...
      [t("tracked.stat_latest"), latestUpdated, t("tracked.stat_latest_detail")],
