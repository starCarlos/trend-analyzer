...
- `NEWSNOW_SOURCE_IDS`
- `GOOGLE_NEWS_ENABLED`
- `GOOGLE_NEWS_HISTORY_DAYS`
- `GOOGLE_NEWS_MAX_ITEMS`
- `DIRECT_RSS_ENABLED`
- `DIRECT_RSS_MAX_ITEMS`
- `DIRECT_RSS_EXTRA_FEEDS`
- `GDELT_ENABLED`
- `GDELT_HISTORY_DAYS`
- `GDELT_MAX_ITEMS`
...
其中 `ARCHIVE_AMBIGUOUS_QUERY_CONTEXTS_JSON` 用来给歧义词补上下文约束。例如某个词既可能是 AI 产品名，也可能是普通名词或人名时，可以通过 JSON 配置附加语义上下文，减少 archive 误命中。
